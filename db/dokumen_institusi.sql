...
-- ----------------------------
-- Table structure for dokumen_institusi
-- ----------------------------
DROP TABLE IF EXISTS `dokumen_institusi`;
CREATE TABLE `dokumen_institusi`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `institusi_id` int(11) NULL DEFAULT NULL,
