        ...
        <div class="gallery">
            @if(request()->dokumentasi == 'individu')
                <a target="_blank" href="{{ asset('dokumen_individu') }}/{{ $img->image }}">
                    <img src="{{ asset('dokumen_individu') }}/{{ $img->image }}" alt="dokumen bukan file jpg, png, jpeg" width="600" height="400">
                </a>
            @elseif(request()->dokumentasi == 'institusi')
                <a target="_blank" href="{{ asset('dokumen_institusi') }}/{{ $img->image }}">
                    <img src="{{ asset('dokumen_institusi') }}/{{ $img->image }}" alt="dokumen bukan file jpg, png, jpeg" width="600" height="400">
                </a>
            @else
                <a target="_blank" href="{{ asset('dokumen_individu') }}/{{ $img->image }}">
                    <img src="{{ asset('dokumen_individu') }}/{{ $img->image }}" alt="dokumen bukan file jpg, png, jpeg" width="600" height="400">
