...
<ol class="breadcrumb mb-4 mt-4">
    <li class="breadcrumb-item"><a href="{{ route('prokes.institusi') }}">Prokes Institusi </a></li>
...
<form action="{{ route('upload.dokumen_institusi') }}" method="post" enctype="multipart/form-data">
    ...
    @endif
        ...
        <div class="row border-top">
            ...
            <img src="{{ asset('dokumen_institusi') }}/{{ $val->image }}" width="100" height="100" style="margin-right: 10px;margin-top: 10px;"/>
            @endforeach
        </div>
        @endsection
    </div>
