...
<div class="container">
    <div class="row">
        <div class="col-md-6 title-sebaran-peta-risiko">
            ...
            ?>
            <h4><strong>Peta Kepatuhan Prokes Individu COVID-19 di Kabupaten Ciamis</strong></h4>
            @php
        ...
        <div class="col-md-6 d-flex justify-content-end p-2">
            <form action='{{ route("peta.peta_prokes") }}' method="get">
    ...
    <div class="row">
        <div class="col-md-8" id="sebaran-kasus">
            <a href="{{ route('peta.peta_institusi') }}" class="btn border mt-2 mr-2" data-bind="institusi">
                <i class="fa fa-building" aria-hidden="true"></i> Prokes Institusi
            </a>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6">
            ...
            <canvas id="densityChart-masker" width="500" height="800"></canvas>
            <canvas id="densityChart-jarak" width="500" height="800"></canvas>
            <canvas id="densityChart-institusi" width="500" height="800"></canvas>
        </div>
    </div>
</div>
@endsection
