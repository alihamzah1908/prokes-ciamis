...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 d-flex justify-content-end p-2">
            <form action='{{ route("peta.peta_institusi") }}' method="get">
    ...
    <div class="row">
        <div class="col-md-8 mb-4">
            <a href="{{ route('peta.peta_prokes') }}" class="btn mt-2 border mr-2" data-bind="institusi">
                <i class="fa fa-male" aria-hidden="true"></i> PROKES INDIVIDU
            </a>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6">
            ...
            <canvas id="densityChart-cuci" width="500" height="800"></canvas>
            <canvas id="densityChart-sosialisasi" width="500" height="800"></canvas>
            <canvas id="densityChart-desinfeksi" width="500" height="800"></canvas>
            <canvas id="densityChart-suhu" width="500" height="800"></canvas>
            <canvas id="densityChart-petugas" width="500" height="800"></canvas>
        </div>
    </div>
</div>
@endsection
